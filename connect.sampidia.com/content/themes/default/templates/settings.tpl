  ...
  <div class="row">
      ...
      <div class="card">
        <div class="card-body with-nav">
          <ul class="side-nav">
            ...
            {if $system['packages_enabled'] || $user->_data['can_monetize_content'] || $user->_data['can_invite_users'] || $system['affiliates_enabled'] || $system['points_enabled'] || $user->_data['can_sell_products'] || $user->_data['can_raise_funding'] || $system['coinpayments_enabled'] || $system['nowpayments_enabled'] || $system['bank_transfers_enabled']}
              <div class="divider mtb5"></div>
            {/if}
            ...
            {if $system['nowpayments_enabled']}
              <li {if $view == "nowpayments"}class="active" {/if}>
                <a href="{$system['system_url']}/settings/nowpayments">
                  <i class="fab fa-bitcoin main-icon mr10" style="color: #64acff; font-size: 24px;"></i>
                  {__("NOWPayments")}
                </a>
              </li>
            {/if}
    ...
    <div class="col-md-8 col-lg-9 sg-offcanvas-mainbar">
      <div class="card">
        ...
        {elseif $view == "nowpayments"}
          {include file='settings.nowpayments.tpl'}
        {elseif $view == "bank"}
