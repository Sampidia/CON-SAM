<div class="card">
  <div class="card-header with-icon">
    <i class="fab fa-bitcoin mr10"></i>{__("NOWPayments Transactions")}
  </div>
  ...
  <div class="card-body">
    ...
    {if !$system['nowpayments_enabled']}
      <div class="alert alert-warning">
        ...
        <div class="text pt5">
          {__("NOWPayments is disabled")}, {__("Make sure you have configured")} <a class="alert-link" href="{$system['system_url']}/{$control_panel['url']}/settings/payments">{__("Payments Settings")}</a>
        </div>
      </div>
    {/if}
    ...
    <div class="alert alert-info">
      ...
      <div class="text pt5">
        {__("You can visit your NOWPayments account to see the transactions in more details")}
      </div>
    </div>
