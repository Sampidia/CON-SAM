        ...
        <div id="payment-methods" class="x-hidden">
          <div class="row justify-content-center text-center">
            ...
            {if $system['nowpayments_enabled']}
              <div class="col-12 col-sm-6 mb10">
                <div class="d-grid">
                  <button class="js_payment-nowpayments btn btn-md btn-payment" onclick="console.log('Direct click NOWPayments');" data-handle="{literal}{{handle}}{/literal}" {literal}{{#id}}{/literal} data-id="{literal}{{id}}{/literal}" {literal}{{/id}}{/literal} {literal}{{#price}}{/literal} data-price="{literal}{{price}}{/literal}" {literal}{{/price}}{/literal}>
                    <i class="fab fa-bitcoin fa-lg fa-fw mr5" style="color: #64acff;"></i>{__("NOWPayments")}
                  </button>
                </div>
              </div>
            {/if}
