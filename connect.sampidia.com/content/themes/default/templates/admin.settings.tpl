          ...
          <div class="card-body">
            ...
            <div>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-9">
                  <select class="form-select" name="coinpayments_instance">
                    <option value="a" {if $system['coinpayments_instance'] == "a"}selected{/if}>{__("Instance A (a-api)")}</option>
                    <option value="b" {if $system['coinpayments_instance'] == "b"}selected{/if}>{__("Instance B (b-api)")}</option>
                  </select>
                  <div class="form-text">
                    {__("Choose the instance assigned to your account (usually 'a')")}
                  </div>
                </div>
              </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-9">
                  <select class="form-select" name="coinpayments_api">
                    <option value="v1" {if $system['coinpayments_api'] == "v1"}selected{/if}>{__("v1 (Legacy)")}</option>
                    <option value="v2" {if $system['coinpayments_api'] == "v2"}selected{/if}>{__("v2 (Modern)")}</option>
                  </select>
                </div>
              </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-9">
                  {if !$user->_data['user_demo']}
                    <input type="text" class="form-control" name="coinpayments_client_id" value="{$system['coinpayments_client_id']}">
                  {else}
                    <input type="password" class="form-control" value="*********">
                  {/if}
                  <div class="form-text">
                    {__("Required for v2 (Modern) API")}
                  </div>
                </div>
              </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-9">
                  {if !$user->_data['user_demo']}
                    <input type="text" class="form-control" name="coinpayments_client_secret" value="{$system['coinpayments_client_secret']}">
                  {else}
                    <input type="password" class="form-control" value="*********">
                  {/if}
                  <div class="form-text">
            ...
            <div>
              <div class="form-table-row">
                <div class="avatar">
                  <img width="40px" height="40px" src="{$system['system_url']}/content/themes/{$system['theme']}/images/nowpayments.png">
                </div>
                <div>
                  <div class="form-label h6">{__("NOWPayments Enabled")}</div>
                  <div class="form-text d-none d-sm-block">{__("Enable payments via NOWPayments")}</div>
                </div>
                <div class="text-end">
                  <label class="switch" for="nowpayments_enabled">
                    <input type="checkbox" name="nowpayments_enabled" id="nowpayments_enabled" {if $system['nowpayments_enabled']}checked{/if}>
                    <span class="slider round"></span>
                  </label>
                </div>
              </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-9">
                  {if !$user->_data['user_demo']}
                    <input type="text" class="form-control" name="nowpayments_api_key" value="{$system['nowpayments_api_key']}">
                  {else}
                    <input type="password" class="form-control" value="*********">
                  {/if}
                </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-9">
                  {if !$user->_data['user_demo']}
                    <input type="text" class="form-control" name="nowpayments_ipn_secret" value="{$system['nowpayments_ipn_secret']}">
                  {else}
                    <input type="password" class="form-control" value="*********">
                  {/if}
                </div>
