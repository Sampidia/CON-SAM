          ...
          <div class="card-body with-nav">
            <ul class="side-nav">
              ...
              <li {if $view == "nowpayments"}class="active" {/if}>
                <a href="{$system['system_url']}/{$control_panel['url']}/nowpayments">
                  {if $nowpayments_insights}<span class="float-end badge rounded-pill bg-danger">{$nowpayments_insights}</span>{/if}
                  <i class="fab fa-bitcoin fa-lg fa-fw mr10" style="color: #4CAF50"></i>{__("NOWPayments")}
                </a>
              </li>
              <!-- CoinPayments -->
