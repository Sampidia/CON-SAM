...
try {
  ...
  switch ($_GET['edit']) {
    ...
    case 'payments_methods':
      ...
      $_POST['nowpayments_enabled'] = (isset($_POST['nowpayments_enabled'])) ? '1' : '0';
      ...
      update_system_options([
        ...
        'nowpayments_enabled' => secure($_POST['nowpayments_enabled']),
        'nowpayments_api_key' => secure($_POST['nowpayments_api_key']),
        'nowpayments_ipn_secret' => secure($_POST['nowpayments_ipn_secret']),
        'coinpayments_enabled' => secure($_POST['coinpayments_enabled']),
        'coinpayments_api' => secure($_POST['coinpayments_api']),
        'coinpayments_instance' => secure($_POST['coinpayments_instance']),
        ...
        'coinpayments_client_id' => secure($_POST['coinpayments_client_id']),
        'coinpayments_client_secret' => secure($_POST['coinpayments_client_secret']),
