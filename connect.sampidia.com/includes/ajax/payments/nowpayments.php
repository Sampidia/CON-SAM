...
/* DEBUG LOGGING */
$log_file = ABSPATH . 'nowpayments_debug.log';
$log_data = "\n--- AJAX " . date('Y-m-d H:i:s') . " ---\n";
$log_data .= "POST Data: " . json_encode($_POST) . "\n";
...
// check if NOWPayments enabled
if (!$system['nowpayments_enabled']) {
...
try {
    switch ($_POST['handle']) {
        case 'packages':
            ...
            // get nowpayments link
            $nowpayments_url = $user->nowpayments("packages", $package['price'], $package['package_id']);
            break;
        ...
        case 'wallet':
            ...
            // get nowpayments link
            $nowpayments_url = $user->nowpayments("wallet", $_POST['price']);
            break;
        ...
        case 'donate':
            ...
            // get nowpayments link
            $nowpayments_url = $user->nowpayments("donate", $_POST['price'], $_POST['post_id']);
            break;
        ...
        case 'subscribe':
            ...
            // get nowpayments link
            $nowpayments_url = $user->nowpayments("subscribe", $monetization_plan['price'], $_POST['plan_id']);
            break;
        ...
        case 'paid_post':
            ...
            // get nowpayments link
            $nowpayments_url = $user->nowpayments("paid_post", $post['post_price'], $_POST['post_id']);
            break;
        ...
        case 'movies':
            ...
            // get nowpayments link
            $nowpayments_url = $user->nowpayments("movies", $movie['price'], $_POST['movie_id']);
            break;
        ...
        case 'marketplace':
            ...
            // get nowpayments link
            $nowpayments_url = $user->nowpayments("marketplace", $orders_collection['total'], $_POST['orders_collection_id']);
            break;
    ...
    // return & exit
    return_json(['nowpayments_url' => $nowpayments_url]);
} catch (Exception $e) {
